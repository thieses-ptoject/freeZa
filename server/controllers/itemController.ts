...
export const GetAllItemsOfOneUsers = async (
  req: Request,
  res: Response
): Promise<void> => {
  const { ownerId } = req.params;
  try {
    ...
    if (All.length > 0) {
      let data1 = All?.filter((ele: any) => {
        return ele.state === "available";
      });

      let data = data1?.map((ele: any) => {
...
export const GetItembyState = async (
  req: Request,
  res: Response
): Promise<void> => {
...
export const GetItemByFreza = async (
  req: Request,
  res: Response
): Promise<void> => {
...
export const UpdateFreeza = async (
  req: Request,
  res: Response
): Promise<void> => {
